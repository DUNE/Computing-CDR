...
\begin{center}
  ...
  {\Huge  Conceptual Design Report -- DRAFT}  %HMS got rid of \n
...
\includegraphics[width=\textwidth]{graphics/World.png}%graphics/dune-firstVersionNotBad-show.jpg}

  \vspace{10mm}
  \today\  \myversion\ for Collaboration Review
    \vspace{15mm}
...
\fancyfoot{}
\fancyfoot[RO]{\textsf{\footnotesize Conceptual Design Report -- \myversion\ Page \thepage}}
