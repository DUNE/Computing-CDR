...
\usepackage{subfiles}
\newcommand{\myversion}{Version 2.0} % version 1.1 sent for review.  
...
% We have decided to utilize the P package for doing calculations and tracking constants in the CDR
...
% Note that you should not override the use of a variable denmcx fined in generated/parameters.tex
...
\part{Resources and Conclusions} %Kirby
...
\subfile{chapters/Conclusions} %Schellman
\cleardoublepage
