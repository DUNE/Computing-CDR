...
\newcommand\daqsampleratevalue{2.0}%MHz
\newcommand\daqsamplerateunits{\mega\hertz}
\newcommand{\daqsamplerate}{\SI[round-mode=places,round-precision=1]{\daqsampleratevalue}{\daqsamplerateunits}\xspace}
