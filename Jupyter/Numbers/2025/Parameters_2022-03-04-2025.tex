...
\centering\includegraphics[height=0.4\textwidth]{Parameters_2022-03-04-2025-Total-CPU.png}\label{TotalCPU}
\caption{CPU time in Wall Hours/year. Squares are measured values for 2021.}
\end{figure}
\begin{figure}[h]
\centering\includegraphics[height=0.4\textwidth]{Parameters_2022-03-04-2025-Cores.png}\label{Cores}
...
\end{figure}
\begin{figure}[h]
\centering\includegraphics[height=0.4\textwidth]{Parameters_2022-03-04-2025-Cumulative-Tape.png}\label{CumulativeTape}
...
\end{figure}
\begin{figure}[h]
\centering\includegraphics[height=0.4\textwidth]{Parameters_2022-03-04-2025-Cumulative-Disk}\label{CumulativeDisk}
