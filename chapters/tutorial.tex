...
And here's how to use a dword: Figure~\ref{fig:required-label} is the logo for \dword{dune}. The dwords are defined in common/glossary.tex. You use \verb|\dword{}| the same way, whether the term is defined as a newduneword or a newduneabbrev.

Test ext glossary plus Comp-specific glossary: Here's a \dword{dune} Dword in glossary.tex. This is from the specific one: \dword{annetest}
