...
As noted in the introduction, the  \dword{dune} far detectors are sensitive to core-collapse supernovae.  Reference \cite{DUNE:2020zfm} describes recent simulation studies of DUNE's sensitivity to core-collapse supernova signals in our Galaxy. \dword{dune} is uniquely sensitive to $\nu_e$ through the reaction $\nu_e + Ar \rightarrow e^- + K*$ which leaves an electron trajectory that can be used to estimate the direction of the supernova.  Figure \ref{fig:SNrates} shows the expected neutrino interaction rates from supernovae as a function of their distance.
...
\section{Visualization}\hideme{Tom Junk}
...
\subsection{Example of protoDUNE analysis \hideme{Jake Calcutt}}
...
\sububsection{Preliminary Event Selection Studies}
