...
Furthermore, the \dword{fft} and other algorithms used heavily in this stage benefit from SIMD acceleration~\ref{Dong:2022wxg} such as provided by GPU devices. 
