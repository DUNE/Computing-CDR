...
\begin{document}
\chapter{Use Cases\hideme{Ready for editing - 2/28}}
\label{ch:use}
\newcommand{\ignore}[1]{{}}
...
A detailed description of the ProtoDUNE-SP and Far Detector reconstruction algorithms is given in Ref.~\cite{DUNE:2020ypp}.  This section outlines those aspects of the reconstruction processing that are directly related to sofware and computing issues.
