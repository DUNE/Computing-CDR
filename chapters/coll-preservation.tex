...
As operating systems and compilers evolve, old code may cease to work or give the same answer. \fixme{'give the same answer'? as what? (anne)} We will not have the resources to perform continuous integration tests on all code versions, so it is likely that reviving old codes will require substantial effort. The priority will be ensuring that the raw data remain accessible. 
