...
\begin{document}
\chapter{Information Systems and Monitoring \hideme{ Steve Timm, Raja Nandakumar, Jon Hays - in progress}}
\label{ch:mon}
...
As the global infrastructure is broadly similar to that used by the current \dword{lhc} experiments, DUNE plans to reuse the relevant monitoring tools (\dword{etf}, \dword{perfsonar}) developed for this purpose by the \dword{wlcg}. %anne, which we cover in this section.
