...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Introduction \hideme{McNab - draft}}
...
\section{Current production workflow submission infrastructure \hideme{Herner - draft}}
\label{sec:current}
...
\section{Workflow Proposal \hideme{McNab - draft}} 
...
\subsection{Generic job factory \hideme{McNab - draft}}
...
\subsection{Workflow Database \hideme{McNab - draft}}
\label{sec:flow:wfdb}
...
\subsection{User commands \hideme{McNab - draft}}
