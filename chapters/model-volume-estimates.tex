...
\fixme{Doug: Can the sentence above be put into the introduction with additional verbage}
...
\fixme{Doug: need text for the subsection that ties in the first table}
...
\fixme{Doug: All figures need the x axis fix for 2020-2040}
