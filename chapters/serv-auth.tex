...
\begin{document}
\chapter{Authentication and Authorization for Distributed Computing\hideme{HMS 5/4 comments from Steve K. and Anne }}
\label{ch:auth}
...
To this end DUNE Computing Management has %anne expressed  HMS I think submitted is better
