...
\section{Requirements Process} %-\hideme{Norman/Laycock in progress}}
...
Given the unique challenges that DUNE data pose, in 2020, the collaboration assembled a task force to define the requirements for its software framework and submitted those requirements to an \dword{hsf} panel for review.   Some of their findings are detailed in the following.
...
\subsection{Analysis\hideme{Norman/Laycock - needs more}}
...
\section{HSF software frameworks review \hideme{Norman/Laycock needs a lot more}}
...
\subsection{The closest match to DUNE's requirements\hideme{Norman/Laycock - needs more}}
...
\section{Plan to go forward \hideme{ Norman -needed }}
