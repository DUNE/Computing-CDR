...
\todo{Needs much more on the actual analysis requirements}
...
%%% THIS REQUIRES THE FLEXIBLE DATA ATOM INTRODUCTION - FROM TR TO SLICE
...
\subsection{Machine Learning} % ML is used at all stages of data processing
...
%The main aim of this document is to describe the data processing steps for simulation and reconstruction of DUNE data.  
...
%%%% FROM MEMORY IN THE SFRT REPORT
