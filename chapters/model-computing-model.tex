...
{fig:prodsites}
{Distribution of wall time for DUNE production jobs in 2022.}
\includegraphics[width=0.5\textwidth]{graphics/Workflow/walltimeplot.png}
\includegraphics[width=0.15\textwidth]{graphics/Workflow/walltimecountry.png}
\includegraphics[width=0.15\textwidth]{graphics/Workflow/walltimesite1.png}
\includegraphics[width=0.15\textwidth]{graphics/Workflow/walltimesite2.png}
\end{dunefigure}
