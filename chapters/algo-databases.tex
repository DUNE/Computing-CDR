...
Figure~\ref{fig:dbmap} shows the relationship between the conditions \dword{db} and the other \dword{dune} databases. For \dword{protodune} the "Master Metadata Store" is a necessary intermediate database that allows for potentially heavy data interpolation tasks to run without creating extra load on the other, often critical, database services.  It provides a useful separation between the online and offline worlds at the cost of data duplication. The final database system design for \dword{dune} will benefit from experience with this design.
...
%  \begin{tabular}{l l l l l} 
 ...
 Task & FY22 & FY23 & FY24 & FY25 & FY26 & FY27 \\ \toprowrule
 
Conditions \dword{db}             & 0.7 & 0.7 & 0.7 & 0.7 & 1.0 & 1.0 \\ \colhline
Payload Serialization             & 0.3 & 0.3 & 0.6 & 0.5 & 0.2 & 0.2 \\ \colhline
Slow control \dword{db}           & 0.3 & 0.3 & 0.3 & 0.3 & 0.3 & 0.3 \\ \colhline
Hardware \dword{db}               & 0.5 & 0.5 & 0.4 & 0.3 & 0.3 & 0.1 \\ \colhline
Run Configuration \dword{db}      & 0.3 & 0.3 & 0.1 & 0.3 & 0.3 & 0.1 \\ \colhline
Calibration \dword{db}            & 0.3 & 0.3 & 0.3 & 0.3 & 0.3 & 0.3 \\ \colhline
Tools and Documentation           & 0.6 & 0.6 & 0.6 & 0.6 & 0.6 & 1.0 \\ \colhline
\colhline
Total effort \dword{db}           & 3.0 & 3.0 & 3.0 & 3.0 & 3.0 & 3.0 \\ 
%%\end{tabular}
